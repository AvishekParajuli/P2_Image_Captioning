...
#case2: numlayers =1, dropout=0.2 outside of lstm;bn(momentum=0.1 default)
#train bn parameters; Adam; xavier initialization; before training upload the case0 weights
...
class DecoderRNN(nn.Module):
    def __init__(self, embed_size, hidden_size, vocab_size,drop_prob=0.2, num_layers=1):
